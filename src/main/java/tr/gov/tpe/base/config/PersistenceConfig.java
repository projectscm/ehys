...
@ComponentScan(basePackages = {"tr.gov.tpe.base.entity"})
@EnableJpaRepositories(basePackages = {"tr.gov.tpe.base.repository"})
public class PersistenceConfig {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    factory.setPackagesToScan("tr.gov.tpe.base.entity");
